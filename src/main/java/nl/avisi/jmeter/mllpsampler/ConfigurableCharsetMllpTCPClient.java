...
public class ConfigurableCharsetMllpTCPClient extends AbstractTCPClient{
    ...
    private static final String CHARSET = JMeterUtils.getPropDefault("tcp.charset", UTF_8.name()); // $NON-NLS-1$

    public ConfigurableCharsetMllpTCPClient() {
            super();
            setEolByte(eolInt);
            if (useEolByte) {
